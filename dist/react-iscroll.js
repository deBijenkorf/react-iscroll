...
var ReactIScroll = function (_React$Component) {
  ...
  _createClass(ReactIScroll, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextContext) {
      var currentPropsJSON = JSON.stringify(this.props);
      var nextPropsJSON = JSON.stringify(nextProps);

      var currentContextJSON = JSON.stringify(this.context);
      var nextContextJSON = JSON.stringify(nextContext);
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var currentOptionsJSON = JSON.stringify(this.props.options);
      var prevOptionsJSON = JSON.stringify(prevProps.options);
    ...
    value: function _performInitializeIScroll() {
      ...
      var iScrollInstance = new iScroll(this._node, options);
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', _extends({ ref: function ref(node) {
